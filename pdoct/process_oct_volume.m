...
%         fftData_Rescaled = fft(rawData_Rescaled);
        ...
        % Windowing process %
%         rawData_HamWin_A = rawData_FPNSub_A...
%             .*repmat(hann(size(rawData_FPNSub_A,1)),[1 size(rawData_FPNSub_A,2)]);
%         rawData_HamWin_B = rawData_FPNSub_B...
%             .*repmat(hann(size(rawData_FPNSub_B,1)),[1 size(rawData_FPNSub_B,2)]);
...
%         rawData_DisComp_A = compDisPhase(rawData_HamWin_A,dispMaxOrder,dispCoeffs_A);
%         rawData_DisComp_B = compDisPhase(rawData_HamWin_B,dispMaxOrder,dispCoeffs_B);
% 
%         rawData_DisComp = cat(2,rawData_DisComp_A,rawData_DisComp_B);
%         fftData_DispComp = fft(rawData_DisComp);
