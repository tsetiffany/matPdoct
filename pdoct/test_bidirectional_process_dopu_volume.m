% to test: load cplxData_A and cplxData_B first
OCT_PN = 8751808.07697023;
OCT_SN = 8049089.41685389;
numBMscans = 4;
...
test_S = cplxData_B(:,:,:);
    ...
    % Crop volume %
    try
        volume_mcorr_ChP = test_P(depthROI(1):depthROI(2),:,:);
        volume_mcorr_ChS = test_S(depthROI(1):depthROI(2),:,:);
    catch
        volume_mcorr_ChP = test_P;
        volume_mcorr_ChS = test_S;
