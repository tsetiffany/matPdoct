...
%     ref_RawData_HamWin_A = ref_RawData_FPNSub_A...
%         .*repmat(hann(size(ref_RawData_FPNSub_A,1)),[1 size(ref_RawData_FPNSub_A,2)]);
%     ref_RawData_HamWin_B = ref_RawData_FPNSub_B...
%         .*repmat(hann(size(ref_RawData_FPNSub_B,1)),[1 size(ref_RawData_FPNSub_B,2)]);
% 
%     ref_RawData_HamWin = cat(2,ref_RawData_HamWin_A,ref_RawData_HamWin_B);
%     ref_FFTData_HamWin = fft(ref_RawData_HamWin);
...
%     dispCoeffs_A = setDispCoeff(ref_RawData_HamWin_A,dispROI,dispMaxOrder,coeffRange);
%     ref_RawData_DisComp_A = compDisPhase(ref_RawData_HamWin_A,dispMaxOrder,dispCoeffs_A);
%     dispCoeffs_B = setDispCoeff(ref_RawData_HamWin_B,dispROI,dispMaxOrder,coeffRange);
%     ref_RawData_DisComp_B = compDisPhase(ref_RawData_HamWin_B,dispMaxOrder,dispCoeffs_B);
% 
%     ref_RawData_DisComp = cat(2,ref_RawData_DisComp_A,ref_RawData_DisComp_B);
%     ref_FFT_DisComp   = fft(ref_RawData_DisComp);
