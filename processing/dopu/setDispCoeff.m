function dispCoeff = setDispCoeff(inputData, maxDispOrders, coeffRange)
...
for i = 1 : length(arrCountDispCoeff)
    ...
    for j = 1 : length(arrDispCoeffRng)
        ...
        arrCost(j) = calCostFunc(frameData, maxDispOrders, arrCountDispCoeff);
    end
    ...
    for k = 1 : 50
        ...
        cost_new = calCostFunc(frameData, maxDispOrders, arrCountDispCoeff);
